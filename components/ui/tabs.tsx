...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      "inline-flex min-h-12 items-center justify-center rounded-lg bg-muted p-1.5 text-muted-foreground border border-border/30 shadow-lg",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent px-4 py-2.5 text-sm font-semibold ring-offset-background transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-card data-[state=active]:text-foreground data-[state=active]:shadow-sm data-[state=active]:border-border/50 hover:bg-card/50 hover:text-foreground/80",
      className
    )}
    {...props}
  />
