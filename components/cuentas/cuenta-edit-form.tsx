...
const DEFAULT_COLORS = [
  "#4ECDC4", "#FF6B6B", "#45B7D1", "#96CEB4", "#DDA0DD",
  "#98D8C8", "#F7DC6F", "#BB8FCE", "#85C1E9", "#F8C471",
  "#82E0AA", "#F1948A", "#D7BDE2", "#FAD7A0", "#A9DFBF"
]
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 pt-6">
      ...
      <div className="space-y-2">
        ...
        <Select value={formData.tipo} onValueChange={(value) => setFormData({ ...formData, tipo: value as "banco" | "caja" })}>
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-2">
        <Label htmlFor="banco_nombre">
          Nombre del banco {formData.tipo === "banco" ? "*" : ""}
        </Label>
        <Input
          id="banco_nombre"
          ...
          disabled={formData.tipo === "caja"}
          className={formData.tipo === "caja" ? "bg-gray-100 text-gray-500" : ""}
        />
        {formData.tipo === "caja" && (
          <p className="text-sm text-gray-500">No aplicable para cajas de ahorro</p>
        )}
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-3">
          <Input
            id="personas"
            placeholder="Escribe un nombre y presiona Enter para añadir"
          ...
          {personasList.length > 0 && (
            <div className="space-y-2">
              <Label className="text-sm text-gray-600">Personas añadidas:</Label>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          placeholder="Descripción adicional de la cuenta (opcional)"
          rows={3}
        />
      </div>
