...
**Panel "Cuadre del ejercicio"**: siempre visible, muestra _Remanente anterior + Entradas − Salidas = Terminas con_, con un badge verde **"Cuadra al céntimo"** o ámbar **"Descuadre de X €"**.
